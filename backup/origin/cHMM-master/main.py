...
# individual hmms
hs_hmm = get_some_results(hs_data, 'HS', hidden_states)
sz_hmm = get_some_results(sz_data, 'SZ', hidden_states)

# joint hmm
joined_hmm = get_some_results(chmm_data, 'HS-SZ', hidden_states * hidden_states)
